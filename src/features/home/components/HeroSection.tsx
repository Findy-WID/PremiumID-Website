        ...
        <div className="container mx-auto px-6 max-w-7xl relative z-10 py-12 md:py-20">
          <div className="flex flex-col md:flex-row items-center">
            ...
            <div className="w-full md:w-3/5 text-center md:text-left">
              <h1 className="inline-block mb-auto bg-gradient-to-br from-premium-accent to-[#f0eab8] bg-clip-text text-transparent text-4xl md:text-6xl lg:text-7xl font-bold leading-[1.1] mb-6">
